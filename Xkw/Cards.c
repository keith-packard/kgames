...
static XtResource resources[] = {
    ...
    {XtNmediumCards, XtCMediumCards, XtRBoolean, sizeof (Boolean),
     offset(medium_cards), XtRImmediate, (XtPointer) False},
...
static Boolean	any_large, made_large;
...
static Boolean	any_medium, made_medium;

extern char **medium_xpm[];

static Pixmap	medium_map[CARDS_PER_DECK];
...
#define MEDIUM_CARD_HEIGHT  96
#define MEDIUM_CARD_WIDTH   71
